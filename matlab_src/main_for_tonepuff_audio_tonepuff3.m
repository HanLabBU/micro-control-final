...
%%
fi = fopen('micro-control-data//mike_tonepuff3_10-8-18_take1.txt'); 
...
save('micro-control-data/tone_puff_table_tone_10-8-18.mat','tbl');
...
%%
d = 'micro-control-data/mike_tonepuff3_10-8-18_take1/Block-1';
data = TDTbin2mat(d);
