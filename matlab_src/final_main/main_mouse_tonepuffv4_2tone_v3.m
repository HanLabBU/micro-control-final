fi = fopen('micro-control-data/mike_2tone_022619/mike_022619_practice_2tone_postpause_2000Hz1_0.05amp1_8000Hz2_0.2amp2.txt');
...
d = 'micro-control-data/mike_2tone_022619/Block-2';
data = TDTbin2mat(d);
