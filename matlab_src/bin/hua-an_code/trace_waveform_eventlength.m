function roi_list=trace_waveform_eventlength(roi_list, save_keyword, waveform_window, sample_freq)
% modified by mike
    ...
    for roi_idx=1:numel(roi_list)
        ...
        roi_list(roi_idx).waveform_time = [waveform_max_idx-pre_idx+1 waveform_max_idx+post_idx-1]; % added this line by Mike
    end
