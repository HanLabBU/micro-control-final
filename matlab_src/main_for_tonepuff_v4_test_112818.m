...
fi = fopen('micro-control-data/test/mike_practice_112818_tonepuffv4_747.txt');
...
save('micro-control-data/tone_puff_table_112818.mat','tbl');

%% now extract data from tdt files
load('micro-control-data/tone_puff_table_112818.mat');

d = 'micro-control-data/test/MikePractice_motor_50_10/Block-4';
data = TDTbin2mat(d);
