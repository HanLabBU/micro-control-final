...
huiw3 = uicontrol('Style','edit', 'Units', 'Normalized', ...
    'Position', [0.35 0.7 0.33 0.05],'string','Motor output file name',...
    'FontName', 'Wawati SC', 'FontSize', 9);
...
function callbackfn1(~,~)
    ...
    fi = fopen([huiw3.String '_' huiw4.String '_' huiw5.String '_' huiw6.String '_' huiw7.String '_' huiw8.String '_' huiw9.String '_' date '.txt'],'w');
